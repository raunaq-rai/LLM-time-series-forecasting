...
\begin{table}[H]
  ...
  Overall, this project presents a promising approach to leveraging large language models for structured prediction tasks under strict compute limitations. By strategically combining efficient adaptation, FLOP-aware design, and targeted hyperparameter optimization, our work lays a strong foundation for further advancements in time-series forecasting and structured numeric prediction using LLMs.
\begin{table}[ht]
  \centering
  \resizebox{\textwidth}{!}{%
